...
app.get('/', (req, res) => {
    // res.send('Hi, this is the default API from Prosper');
    // res.status(500);
    res.json({
        message: 'This is my json obj'
    });
});
